...
var temp = Todo(title: "写作业",startDate: Date(timeIntervalSinceNow: -1000), endDate: Date(timeIntervalSinceNow: 300), circle: "2021级计科7班")
            ...
            VStack{
                HStack{
                    ...
                    Image(systemName: "c.circle")
                        ...
                        .tint(.black)
                    Spacer().frame(width: 20)
                    Text(todoshop.todos[locate].circle) .font(.system(size: 20))
                    Spacer()
                }.padding(20)
            }
            .frame(width: UIScreen.main.bounds.width-50)
...
struct ItemDetail_Previews: PreviewProvider {
    static var previews: some View {
        ItemDetail(todoshop: TodoShop(), locate: 0)
    }
}
